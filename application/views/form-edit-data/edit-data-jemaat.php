                    ...
                    <form action="<?= base_url('jemaat/update_data')?>" method="POST">
                        <div class="row">
                            <div class="col-sm-12 mb-5">
                                ...
                                <div class="form-group row">
                                    <label for="" class="col-sm-2 col-form-label">ID Alamat</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" disabled name="id_alamat" value="<?php echo $jemaat->id_alamat; ?>">
                                        </div>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="pelayanan" class="form-control">
                                                    <option <?php if($jemaat->pelayanan == "1") {echo "selected='selected'";} echo $jemaat->pelayanan;?> value="1">Anggota Jemaat</option>
                                                    <option <?php if($jemaat->pelayanan == "2") {echo "selected='selected'";} echo $jemaat->pelayanan;?> value="2">Majelis Jemaat</option>
                                                    <option <?php if($jemaat->pelayanan == "3") {echo "selected='selected'";} echo $jemaat->pelayanan;?> value="3">Koordinator Sektor</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="pelkat" class="form-control">
                                                    <option <?php if($jemaat->pelkat == "1") {echo "selected='selected'";} echo $jemaat->pelkat;?> value="1">Pelayanan Anak</option>
                                                    <option <?php if($jemaat->pelkat == "2") {echo "selected='selected'";} echo $jemaat->pelkat;?> value="2">Pelayanan Teruna</option>
                                                    <option <?php if($jemaat->pelkat == "3") {echo "selected='selected'";} echo $jemaat->pelkat;?> value="3">Gerakan Pemuda</option>
                                                    <option <?php if($jemaat->pelkat == "4") {echo "selected='selected'";} echo $jemaat->pelkat;?> value="4">Persekutuan Kaum Bapak</option>
                                                    <option <?php if($jemaat->pelkat == "5") {echo "selected='selected'";} echo $jemaat->pelkat;?> value="5">Persekutuan Kaum Perempuan</option>
                                                    <option <?php if($jemaat->pelkat == "6") {echo "selected='selected'";} echo $jemaat->pelkat;?> value="6">Persekutuan Kaum Lansia</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
